...
--INSERT INTO WFS_CONFIG (type, fixed, sort, created_time, name, value) VALUES ("hdfs", true,  1,  now(), "fs.defaultFS", "hdfs://dataservice02.skcc.com:8020");
...
INSERT INTO WFS_CONFIG (type, fixed, sort, created_time, name, value) VALUES ("hdfs", true,  1,  now(), "fs.defaultFS", "hdfs://dataservice01.skcc.com:8020");
INSERT INTO WFS_CONFIG (type, fixed, sort, created_time, name, value) VALUES ("yarn", true, 1, now(), "yarn.resourcemanager.address", "dataservice02.skcc.com:8050");
INSERT INTO WFS_CONFIG (type, fixed, sort, created_time, name, value) VALUES ("yarn", true, 2, now(), "mapreduce.jobhistory.webapp.address", "dataservice02.skcc.com:19888");
INSERT INTO WFS_CONFIG (type, fixed, sort, created_time, name, value) VALUES ("oozie", true, 1, now(), "oozie.url", "http://dataservice05.skcc.com:11000/oozie");
...
INSERT INTO WFS_CONFIG (type, fixed, sort, created_time, name, value) VALUES ("oozie", true, 3, now(), "oozie.notification.url", "http://dataservice02.skcc.com:7070");
